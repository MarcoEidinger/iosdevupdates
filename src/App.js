				...
				{this.state.showInfoBar === true &&
					<div class="alert hidden lg:flex">
						<div class="flex-1">
							...
							<label>Site refresh occurs every 2h</label>
						</div>
						<div class="flex-none">
						...
						<div class="flex-none ">
							...
							<div id="about-modal" class="modal">
								<div class="modal-box">
									...
									<br></br>
									<p>I personally was overwhelmed with the sheer amount of sites created by amazing people. I wondered how many sites are active, and I wanted to get an overview of the most recent blogs. Hence I created this website. I hope you find it helpful.</p>
									<br></br>
									<p>Cheers, Marco</p>
