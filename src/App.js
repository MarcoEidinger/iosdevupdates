            ...
            <div className="App">
                <div class="alert">
                    <div class="flex-1">
                        ...
                        <label>Site refresh occurs every 3h --- CHECK</label>
                    </div>
                </div>
                ...
                <footer class="items-center p-4 footer bg-neutral text-neutral-content">
                    ...
                    <div class="grid-flow-col gap-4 md:justify-self-end">
                        <div class="flex-none ">
                            <a href="/components/modal#my-modal" class="btn btn-sm btn-ghost mr-2">About</a>
                            <div id="my-modal" class="modal">
                                <div class="modal-box">
                                    ...
                                    <div class="modal-action">
                                        <a href="/components/modal#" class="btn btn-primary">Ok</a>
                                    </div>
                                </div>
                            </div>
                        </div>
